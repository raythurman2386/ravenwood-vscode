...
- **Dynamic Regeneration:** Theme files regenerate automatically when configuration changes — a single, dismissible "Reload window" notification is shown after theme regeneration.
